...
public class SecurityConfiguration {
    ...
    private static final String[] PUBLIC_URLS = {"/api/v1/booking/register",
            "/api/v1/booking/login",
            "/api/v1/booking/reset-password",
            "/api/v1/booking/verify/password/**",
            "api/v1/booking/reset-password/key"};
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity security) throws Exception {
        return security.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(configurer -> configurer
                        ...
                        .requestMatchers(GET, "/api/v1/booking/user/profile").hasAnyAuthority("USER:READ","ADMIN:READ")
                        .requestMatchers(POST, "/api/v1/booking/user/reset-password").hasAnyAuthority("USER:WRITE","ADMIN:WRITE")
                        .requestMatchers(GET, "/api/v1/booking/slots/**").hasAnyAuthority("USER:READ","ADMIN:READ")
                        .requestMatchers(POST, "/api/v1/booking/book").hasAnyAuthority("USER:CREATE","ADMIN:CREATE")
                        .requestMatchers(POST, "/api/v1/booking/cancel").hasAnyAuthority("USER:DELETE","ADMIN:DELETE")
                        .requestMatchers(GET, "/api/v1/booking").hasAnyAuthority("USER:READ","ADMIN:READ")
